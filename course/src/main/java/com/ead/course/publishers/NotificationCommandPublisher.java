...
public class NotificationCommandPublisher {
    ...
    public void publisherNotificationCommand(NotificationCommandDto notificationCommandDto) {
        this.rabbitTemplate.convertAndSend(this.notificationCommandExchange, this.notificationCommandKey, notificationCommandDto);
    }
}
